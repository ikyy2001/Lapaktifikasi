        ...
        <div class="col-12">
            <div class="card shadow p-3 mb-5 bg-white rounded mt-3">
                <div class="ml-4">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <form method="post" action="{{ route('menu_produk_digital.update', $data->id_produk) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="d-flex align-items-center" style="gap: 10px;">
                                    ...
                                    <a href="{{ url('menu_produk_digital') }}" class="btn btn-secondary">Batal</a>
                                </div>
                            </form>
                        </div>
                    </div>
