...
<div class="container-fluid py-2">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <h1 class="h3 font-weight-bold text-dark mb-0">Edit Berita</h1>
        </div>
    </div>
    ...
    <form action="{{ route('admin.news.update', $news->id) }}" method="POST" enctype="multipart/form-data" id="newsForm">
        @csrf
        @method('PUT')
        <input type="hidden" name="konten" id="kontenHiddenInput" value="{{ old('konten', $news->konten) }}">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-xl-9">
                ...
                <div class="editor-container-card mb-3">
                    ...
                    <div id="quillEditor">{!! old('konten', $news->konten) !!}</div>
                ...
                <div class="editor-container-card mb-4">
                    <textarea name="subjudul" 
                              ...
                              maxlength="255">{{ old('subjudul', $news->subjudul) }}</textarea>
            ...
            <div class="col-lg-4 col-xl-3">
                ...
                <div class="sidebar-settings-card">
                    ...
                    <button type="submit" class="btn btn-primary btn-block font-weight-bold py-2 shadow-sm mb-2" id="submitBtn">
                        <i class="bi bi-check2-circle mr-1"></i> Perbarui Berita
                    </button>
                ...
                <div class="sidebar-settings-card">
                    ...
                    <p class="small text-muted mb-3">Upload atau ubah gambar thumbnail untuk tampilan card & header artikel.</p>

                    <div class="upload-zone" id="uploadZone" onclick="document.getElementById('coverImageInput').click();">
                        <div id="uploadPlaceholder" style="{{ $news->gambar ? 'display: none;' : '' }}">
                        ...
                        <div id="imagePreviewWrapper" style="{{ $news->gambar ? 'display: block;' : 'display: none;' }}">
                            <img id="coverPreview" src="{{ $news->gambar ? $news->gambar_url : '#' }}" alt="Cover Preview" class="cover-preview-img mb-2 shadow-sm">
