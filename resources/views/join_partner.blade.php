...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero-title { font-family: 'Space Grotesk', sans-serif; font-size: clamp(2.3rem, 5vw, 3.8rem); font-weight: 700; line-height: 1.1; margin-bottom: 24px; animation: fadeInUp 0.7s ease 0.1s both; }
        ...
        @media (max-width: 768px) {
            ...
            .registration-box { padding: 48px 24px; }
        }
    </style>
</head>
<body>
