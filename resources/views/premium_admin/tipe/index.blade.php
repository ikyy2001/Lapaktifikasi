                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="id_produk" required>
                                                        @foreach($produk as $p)
                                                        <option value="{{ $p->id_produk }}" {{ $p->id_produk == $item->id_produk ? 'selected' : '' }}>{{ $p->nama_produk }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-group">
        ...
        <div class="modal-content">
            <form action="{{ route('premium.tipe.store') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Nama Tipe Layanan</label>
                        <input type="text" class="form-control" name="nama_tipe" placeholder="Contoh: Private, Sharing" required>
                    </div>
                    <div class="form-group">
                        <label>Status</label>
                        <select class="form-control" name="status">
